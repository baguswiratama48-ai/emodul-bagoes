...
// LKPD for PKWU - Sumber Daya Usaha (6M)
const pkwuSumberDayaLkpdProblems = [
  {
    id: 1,
    icon: "🧠",
    title: "Analisis Man (Manusia)",
    story: "Sumber daya manusia adalah faktor paling penting dalam usaha. Pikirkan sebuah usaha kerajinan yang ingin kamu buat.",
    question: "Sebutkan kriteria SDM (tenaga kerja) yang dibutuhkan untuk usaha kerajinanmu! (Misal: keahlian, sikap, jumlah)",
    hint: "Contoh: 2 orang pengrajin yang teliti, 1 orang marketing yang komunikatif",
    rubrik: "Skor 20: Kriteria SDM detail dan relevan dengan usaha"
  },
  {
    id: 2,
    icon: "💰",
    title: "Analisis Money (Uang)",
    story: "Setiap usaha membutuhkan modal. Tidak harus besar, yang penting cukup untuk memulai.",
    question: "Perkirakan modal awal yang dibutuhkan untuk membeli bahan dan alat sederhana! Rincikan pengeluarannya.",
    hint: "Buat daftar belanja sederhana. Misal: Lem Rp10.000, Gunting Rp15.000, dst.",
    rubrik: "Skor 20: Rincian modal logis dan realistis"
  },
  {
    id: 3,
    icon: "🧱",
    title: "Analisis Material (Bahan)",
    story: "Pemilihan bahan baku sangat menentukan kualitas produk kerajinan.",
    question: "Bahan limbah apa saja yang akan kamu gunakan? Bagaimana cara mendapatkannya agar stok tetap aman?",
    hint: "Contoh: Limbah plastik dari bank sampah sekolah, kain perca dari penjahit dekat rumah",
    rubrik: "Skor 20: Strategi pengadaan bahan baku jelas"
  },
  {
    id: 4,
    icon: "⚙️",
    title: "Analisis Machine (Alat/Teknologi)",
    story: "Alat bantu bisa mempercepat produksi dan meningkatkan kualitas.",
    question: "Alat apa saja yang wajib ada untuk memproduksi kerajinanmu? Apakah ada alat khusus?",
    hint: "Gunting, lem tembak, mesin jahit, atau alat pres sederhana",
    rubrik: "Skor 20: Daftar alat lengkap sesuai kebutuhan produksi"
  },
  {
    id: 5,
    icon: "📈",
    title: "Analisis Market (Pasar)",
    story: "Produk bagus tidak akan laku jika tidak ada yang membeli atau salah target pasar.",
    question: "Dimana kamu akan menjual produkmu? (Online/Offline) Dan mengapa memilih tempat tersebut?",
    hint: "Marketplace, media sosial, pameran sekolah, atau titip di warung",
    rubrik: "Skor 20: Strategi tempat penjualan (Place) logis dan potensial"
  }
];
